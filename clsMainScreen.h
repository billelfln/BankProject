...
#include"clsDeliteClientScreen.h"
...
private:
	...
	enum enMainMenueOptions {
		...
		eManageUsers = 7, eLoginRegister=8,eCurrencyExtchange=9, eExit = 10
	};
	...
	static void _ShowDeleteClientScreen()
	{
		...
		clsDeliteClientScreen::ShowDeleteClientScreen();
	}
	...
	{
		clsCurrencyExchangeScreen::ShowMainCurrencyExchangeScreen();
	}
	static void _Logout()
	{
