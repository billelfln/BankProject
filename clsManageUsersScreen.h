...
#include"clsDeliteUserScreen.h"
#include"clsUpdateUserScreen.h"
#include"clsFindUserScreen.h"
#include"clsDiliteAllUsersScreen.h"
#include <iomanip>
...
private:
	enum enManageUsersMenueOptions {
		...
		eUpdateUser = 4, eFindUser = 5, eMainMenue = 6,eDileteAll=7
	};
	...
	static void _ShowDeleteUserScreen()
	{
		...
		clsDeliteUserScreen::ShowDeleteClientScreen();
	...
	static void _ShowDiliteAllUsersScreen()
	{
		clsDiliteAllUsersScreen::ShowDiliteAllUserScreen();
	}
	...
	static void _PerformManageUsersMenueOption(enManageUsersMenueOptions ManageUsersMenueOption)
	{
		...
		case enManageUsersMenueOptions::eDileteAll:
		{

			system("cls");
			_ShowDiliteAllUsersScreen();
			_GoBackToManageUsersMenue();
		}
...
public:
	...
	static void ShowManageUsersMenue()
	{
		...
		cout << setw(37) << left << "" << "\t[7] Dilete all Users.\n";
		cout << setw(37) << left << "" << "===========================================\n";
